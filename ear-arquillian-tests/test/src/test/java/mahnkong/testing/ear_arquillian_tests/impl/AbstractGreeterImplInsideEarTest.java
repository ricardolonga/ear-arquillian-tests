...
public class AbstractGreeterImplInsideEarTest {
    ...
    public static EnterpriseArchive createEarDeployment() {
        ...
        File earFile = Maven.configureResolver().fromFile(new File("C:/tools/apache-maven-3.1.1/conf/settings.xml")).resolve("mahnkong.testing:ear-arquillian-tests-ear:ear:1.0").withoutTransitivity().asSingleFile();
